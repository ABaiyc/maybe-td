...
const TOWERS := {
	...
	"BB": {"n": "机枪塔", "t": 2, "c": "BB", "dmg": 9.0, "rng": 200.0, "cd": 0.16, "bhv": "single", "pierce": 0, "splash": 0.0, "debuff": false, "col": "e6b03a", "desc": "双管齐射攻速×2.5，越打越快（叠3层）。"},
	...
	"barrage": {"n": "弹幕炮塔", "t": 3, "c": "EEEB", "dmg": 22.0, "rng": 210.0, "cd": 0.8, "bhv": "aoe", "pierce": 0, "splash": 90.0, "debuff": true, "col": "df6acf", "desc": "弹幕覆盖：扇形倾泻12发元素弹，多debuff叠加。"},
	...
	"gl_array": {"n": "元素榴弹阵列", "t": 3, "c": "EEBB", "dmg": 36.0, "rng": 230.0, "cd": 1.3, "bhv": "aoe", "pierce": 0, "splash": 130.0, "debuff": true, "col": "d6b05a", "desc": "齐射轰炸：一次6发榴弹，落地留元素残渣灼烧。"},
